...
login = input("Login: ")
senha = input("Senha: ")
# Here you need to put the chromedrive path
...
time.sleep(3)
# Searching for path to Login and Password and adding it
...
login_attempt.click()
time.sleep(5)
# Opening the lateral bar, because the page needs to refresh
...
time.sleep(10)
# Downloading in your download folder
